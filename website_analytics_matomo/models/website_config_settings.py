...
class ResConfigSettings(models.TransientModel):
    ...
    matomo_analytics_id = fields.Integer(
        related="website_id.matomo_analytics_id", readonly=False, string="Matomo Analytic ID"
    )
    matomo_analytics_host = fields.Char(
        related="website_id.matomo_analytics_host", readonly=False, string="Matomo Host"
    )
